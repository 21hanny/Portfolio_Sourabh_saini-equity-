...
hosted web - https://sourabhsainiinvestment.tiiny.site/
---
...
| Benchmark | Portfolio Return (XIRR) | Benchmark Return | Outperformance | Multiple (vs. Benchmark) |
| :--- | :--- | :--- | :--- | :--- |
| **vs. NIFTY 50** | +145.74% | +28.30% | **+117.44 pp** | **5.15x** |
| **vs. NIFTY 500** | +145.74% | +32.77% | **+112.97 pp** | **4.45x** |
| **vs. NIFTY Midcap 150** | +145.74% | +44.79% | **+100.95 pp** | **3.25x** |
| **vs. NIFTY Smallcap 250** | +145.74% | +51.08% | **+94.66 pp** | **2.85x** |
